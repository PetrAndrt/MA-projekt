...
# Odeslani na server streamlit
# 
# Presunout se do pracovni slozky kde mas projekt
#>> cd Desktop\PYTHON2
#
# Zobrazit zmeny ktere jsi udelal
#>> git status
#
